...
public class RecentsActivity extends Activity {
    ...
    private final String TAG="RecentsActivity";
    public boolean performFeedback(boolean always) {
        if (mVibrator == null || !mVibrator.hasVibrator()) {
            return false;
        }
        final boolean hapticsDisabled = Settings.System.getIntForUser(getContentResolver(),
    ...
    private BroadcastReceiver mIntentReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            if (CLOSE_RECENTS_INTENT.equals(intent.getAction())) {
                ...
                && mRecentsPanel.isShowing()) {
               // {
                   // if (mShowing && !mForeground) {
                        // Captures the case right before we transition to
                        // another activity
                        Log.d("Recents","CLOSE_RECENTS_INTENT="+Boolean.valueOf(mShowing)+","+Boolean.valueOf(mForeground));
                    		dismissAndGoHome();
                    //}
    ...
    public class TouchOutsideListener implements View.OnTouchListener {
        ...
        public boolean onTouch(View v, MotionEvent ev) {
            ...
            if (action == MotionEvent.ACTION_OUTSIDE
                    || (action == MotionEvent.ACTION_DOWN && !mPanel.isInContentArea(
    ...
    @Override
    public void onPause() {
        overridePendingTransition(R.anim.recents_return_to_launcher_enter,
      ...
      //  moveToBack();
        ...
        AliUserTrackUtil.pageLeave("Multitask");
    }
    ...
    public void onResume() {
        mForeground = true;
        super.onResume();
        AliUserTrackUtil.pageEnter("Multitask");
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        WindowManager.LayoutParams.FLAG_FULLSCREEN); //lurui
		 
        setContentView(R.layout.status_bar_recent_panel_n);
        mRecentsPanel = (RecentsPanelView) findViewById(R.id.recents_root);
        // mRecentsPanel.setOnTouchListener(new
        // TouchOutsideListener(mRecentsPanel));
        ...
        mRecentsPanel.setMinSwipeAlpha(getResources().getInteger(
                R.integer.config_recent_item_min_alpha) / 100f);
        ...
        mRecentsPanel.setStatusBar(mStatusBar);
    }
    ...
    private void handleIntent(Intent intent, boolean checkWaitingForAnimationParam) {
        ...
        Log.d(TAG, "showing:" + mRecentsPanel != null ? mRecentsPanel.isShowing() + "" : "null");
