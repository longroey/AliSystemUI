...
public class RecentsVerticalScrollView extends ScrollView implements RecentsSwipeHelper.Callback,
    ...
    public RecentsVerticalScrollView(Context context, AttributeSet attrs) {
        ...
        mSwipeHelper = new RecentsSwipeHelper(RecentsSwipeHelper.X, this, densityScale,
                pagingTouchSlop);
    ...
    private void update() {
        ...
        for (int i = 0; i < mAdapter.getCount(); i++) {
           ...
           /* luruifinal View calloutLine = view.findViewById(R.id.recents_callout_line);
            if (calloutLine != null) {
    ...
    public View getChildAtPosition(MotionEvent ev) {
        ...
        for (int i = 0; i < mLinearLayout.getChildCount(); i++) {
            ...
            if (item.getVisibility() == View.VISIBLE && x >= item.getLeft() && x < item.getRight()
    ...
    public void drawFadedEdges(Canvas canvas, int left, int right, int top, int bottom) {
        if (mFadedEdgeDrawHelper != null) {
            ...
            mFadedEdgeDrawHelper.drawCallback(canvas, left, right,
                    top + getFadeTop(offsetRequired), bottom, mScrollX, mScrollY,
                    getTopFadingEdgeStrength(), getBottomFadingEdgeStrength(), 0, 0, mPaddingTop);
        }
    }
    ...
    protected void onFinishInflate() {
        ...
        final int leftPadding = getContext().getResources().getDimensionPixelOffset(
    ...
    public void setAdapter(TaskDescriptionAdapter adapter) {
        ...
        int childWidthMeasureSpec = MeasureSpec
                .makeMeasureSpec(dm.widthPixels, MeasureSpec.AT_MOST);
        int childheightMeasureSpec = MeasureSpec.makeMeasureSpec(dm.heightPixels,
                MeasureSpec.AT_MOST);
