...
public class VolumePanel extends Handler implements DemoMode {
    ...
    private static boolean LOGD = false; //Log.isLoggable(TAG, Log.DEBUG);
    ...
    private int getStreamMaxVolume(int streamType) {
        if (streamType == STREAM_MASTER) {
            /*YUNOS BEGIN*/
            //##desc: use stream music, sync with QS Volume control
            //##date:2016-04-14    ##author:ason.huxs@alibaba-inc.com
...
//                mAudioManager.setMasterVolume(index, flags);
                mAudioManager.setStreamVolume(AudioManager.STREAM_MUSIC, index, flags);
                /*YUNOS END*/
            } else {
