...
class WifiIcons {
    ...
    static final int[] YUNOS_WIFI_SIGNAL_STRENGTH = 
            { R.drawable.stat_sys_wifi_0,
              R.drawable.stat_sys_wifi_0,
              R.drawable.stat_sys_wifi_1,
              R.drawable.stat_sys_wifi_2,
              R.drawable.stat_sys_wifi_3 };
/*
...
*/
    ...
    static void initWifiIcon() {
        WIFI_SIGNAL_STRENGTH[0] = YUNOS_WIFI_SIGNAL_STRENGTH;
        WIFI_SIGNAL_STRENGTH[1] =YUNOS_WIFI_SIGNAL_STRENGTH;
        QS_WIFI_SIGNAL_STRENGTH[0] = YUNOS_WIFI_SIGNAL_STRENGTH;
        QS_WIFI_SIGNAL_STRENGTH[1] = YUNOS_WIFI_SIGNAL_STRENGTH;
    }
    /// M: config for show the ! icon or not . @}
