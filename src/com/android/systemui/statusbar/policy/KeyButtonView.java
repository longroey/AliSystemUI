...
public class KeyButtonView extends ImageView {
        ...
        public void run() {
            if (isPressed()) {
                ...
                if(mCode == KeyEvent.KEYCODE_HOME){
                	//track long click home button
                	Map<String, String> lMap = new HashMap<String, String>();
                    lMap.put("keycode", mCode + "");
                    AliUserTrackUtil.ctrlClicked("Navigation", "Long_Click_Home", lMap);
                }
            }
        }
    };
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        if(factoryModeOn() && mCode != KeyEvent.KEYCODE_BACK){
           android.util.Log.d("fullscreen","factory mode on, ignore touch event. ");
           return true;
        }
    ...
    void sendEvent(int action, int flags, long when) {
        ...
        AliUserTrackUtil.ctrlClicked("Navigation", componentName, lMap);
