...
public class TelephonyIcons {
    ...
    static final int[] YUNOS_TELEPHONY_SIGNAL_STRENGTH = {
          R.drawable.signal_0,
          R.drawable.signal_1,
          R.drawable.signal_2,
          R.drawable.signal_3,
    ...
    static void initTelephonyIcon() {
        TELEPHONY_SIGNAL_STRENGTH[0] = YUNOS_TELEPHONY_SIGNAL_STRENGTH;
        TELEPHONY_SIGNAL_STRENGTH[1] = YUNOS_TELEPHONY_SIGNAL_STRENGTH;
        QS_TELEPHONY_SIGNAL_STRENGTH[0] = YUNOS_TELEPHONY_SIGNAL_STRENGTH;
        QS_TELEPHONY_SIGNAL_STRENGTH[1] = YUNOS_TELEPHONY_SIGNAL_STRENGTH;
        TELEPHONY_SIGNAL_STRENGTH_ROAMING[0] = YUNOS_TELEPHONY_SIGNAL_STRENGTH;
        TELEPHONY_SIGNAL_STRENGTH_ROAMING[1] = YUNOS_TELEPHONY_SIGNAL_STRENGTH;
