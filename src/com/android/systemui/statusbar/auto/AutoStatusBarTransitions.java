...
public final class AutoStatusBarTransitions extends BarTransitions {
    ...
    private final AutoStatusBarView mView;
    private final float mIconAlphaWhenOpaque;

    private View mLeftSide, mStatusIcons, mSignalCluster, mBattery, mClock;
    private Animator mCurrentAnimation;

    public AutoStatusBarTransitions(AutoStatusBarView view) {
