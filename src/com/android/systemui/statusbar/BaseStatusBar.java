...
public abstract class BaseStatusBar extends SystemUI implements
    ...
    public static final boolean DEBUG = false; //Log.isLoggable(TAG, Log.DEBUG);
    ...
    protected NotificationStackFrameLayout mStackFrameLayout;
...
/*not show notification layout*/        
//        if (!inflateViews(entry, mStackFrameLayout/*mStackScroller*/)) {
...
/*not show notification layout*/
//                    inflateViews(oldEntry, mStackFrameLayout/*mStackScroller*/, wasHeadsUp);
                    mNotificationData.updateRanking(ranking);
                    updateNotifications();
                }
            }
