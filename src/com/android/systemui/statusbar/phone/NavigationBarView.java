...
public class NavigationBarView extends LinearLayout {
    ...
    public View getVoiceButton() {
        return mCurrentView.findViewById(R.id.voice);
    }
    ...
    public void reorient() {
        ...
        mCurrentView = mRotatedViews[Surface.ROTATION_90/*rot*/];
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        mDelegateHelper.setInitialTouchRegion(getHomeButton(), getBackButton(), getVoiceButton());
    }
