...
public class StatusBarKeyguardViewManager {
    ...
    public void show(Bundle options) {
        ...
        Log.d(TAG, "mContainer.getSystemUiVisibility() = "+mContainer.getSystemUiVisibility());
        reset();
    }
...
//        private KeyguardHostView mKeyguardView;
        ...
        public void goToUnlockScreen(boolean unlock, PendingIntent pending) {
            if (mBouncer != null)
            	mBouncer.goToUnlockScreen(unlock, pending);
        }

        public void goToLockScreen() {
            if (mBouncer != null)
            	mBouncer.goToLockScreen();
        }
    /*YUNOS END*/
...
//    	Log.d(TAG, "mOccluded = "+mOccluded+", occluded = "+occluded+", mShowing = "+mShowing);
