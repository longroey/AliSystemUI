...
public class HotspotTile extends QSTile<QSTile.BooleanState> {
    private static final String ACTION_HOTSPOT_SETTINGS = "android.intent.action.TETHER_WIFISETTINGS";
...
//        Log.d(TAG, "handleClick(), airplaneMode= " + airplaneMode);
        ...
        AliUserTrackUtil.ctrlClicked("Controlcenter", "Hotspot", on);
...
//        mDisable.setAllowAnimation(true);
    ...
    protected void handleLongClick() {
        ...
        */
    	mHost.startSettingsActivity(new Intent(ACTION_HOTSPOT_SETTINGS));
    }

    @Override
    protected void handleUpdateState(BooleanState state, Object arg) {
    	//not limit to users, just open it.
        state.visible = mController.isHotspotSupported()/* && mUsageTracker.isRecentlyUsed()*/;
        state.label = mContext.getString(R.string.qs_label_hot_spot);
        ...
        state.icon = state.visible && state.value ? 
        		ResourceIcon.get(R.drawable.control_hotspot_on_bg) : ResourceIcon.get(R.drawable.control_hotspot_off_bg);
    }
