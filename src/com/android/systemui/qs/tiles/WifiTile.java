...
public class WifiTile extends QSTile<QSTile.SignalState> {
    ...
    protected void handleClick() {
        ...
        int on = mState.enabled ? 1 : 0;
        AliUserTrackUtil.ctrlClicked("Controlcenter", "Wifi", on);
...
//        }
    ...
    protected void handleSecondaryClick() {
        ...
        showDetail(true);
        int on = mState.enabled ? 1 : 0;
        AliUserTrackUtil.ctrlClicked("Controlcenter", "Wifi_Detail", on);
    }
...
//        state.activityOut = cb.enabled && cb.activityOut;
        ...
        if (!state.enabled) {
            state.icon = ResourceIcon.get(R.drawable.control_wifi_off_bg);
            state.label = r.getString(R.string.quick_settings_wifi_label);
            signalContentDescription = r.getString(R.string.accessibility_wifi_off);
        } else if (wifiConnected) {
            state.icon = ResourceIcon.get(R.drawable.control_wifi_on_bg);
